...
public class BaiduPush {
	...
	public String PushNotify(String title, String message, String userid) {
		...
		//'pkg_content':'intent:#Intent;launchFlags=0x10000000;component=com.yiyu.cg.daifa.androidnative/com.yiyu.cg.daifa.androidnative.push.NoticeActivity;end'
		String msg = String.format("{'title':'%s','description':'%s','notification_builder_id':0,'notification_basic_style':7,'open_type':2,'pkg_content':'intent:#Intent;launchFlags=0x10000000;component=com.yiyu.cg.daifa.androidnative/com.yiyu.cg.daifa.androidnative.push.NoticeActivity;end','custom_content':{'test':'test'}}", title, jsonencode(message));
