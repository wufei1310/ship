...
class ShipSN {
    ...
    String status;//new新登记包裹　noowner无主包裹　giveup 放弃不要了            //0：物流单不存在 1:已核实，广州办收货确认2：单号匹配，商品数量不符 3:无主包裹，手工关联入库  4:已分配代发人员 5:已由代发人员退货完成 6与代发人员已结账 7:已关联订单号包裹 8　退货进行中无主包裹
