...
<g:form name="addDaiFaForm" id="addDaiFaForm" data-validate="parsley" class="form-signin addDaiFaForm"
        controller="memberDaiFaOrder" action="doAddBack" method="post">
    <input name="kid" value="${kingsReturnOrder.id}" type="hidden">
<h4>1.商品信息
</h4>
    ...
    <table class="table table-bordered">
        ...
        <g:if test="${goodsList}">
            <g:each in="${goodsList}" status="i" var="daiFaGoods">
                <tr class="daiFaGoods">
                    <td>
                        <g:select readonly="" class="input-small marketselect" value="${daiFaGoods.market}" name="market" from="${market}"/>
                        <select readonly name="floor" class="input-small floorselect">
                    ...
                    <td><input readonly name="stalls" class="input-medium stalls" type="text" placeholder=""
                               value="${daiFaGoods.stalls}"></td>
                    <td><input readonly name="goods_sn" class="input-small goods_sn" type="text" placeholder=""
                               value="${daiFaGoods.goods_sn}"></td>
                    <td><input readonly name="spec" class="input-small spec" type="text" placeholder=""
                               value="${daiFaGoods.spec}"></td>
                    <td><input readonly onkeyup="if (isNaN(value))execCommand('undo')"
...
<div class="bs-docs-example">
    <table class="table table-bordered">
        ...
        <tr>
            <td>
                <strong style="display: none;" id="goodsFee">0</strong>
                <input type="hidden" name="goodsFee">
                运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：&nbsp;<strong id="shipFee">0</strong>
                <input type="hidden" name="shipFee">
                <strong style="display: none;" id="serviceFee">0</strong>
                <input type="hidden" name="serviceFee">
                <strong style="display: none;"  id="regardsFee">0</strong>
                <input type="hidden" name="regardsFee">
                &nbsp;<strong style="display: none;"  id="totalFee">0</strong>
                <input type="hidden" name="totalFee">
                <!--                <br/>
                                  账户余额：<strong style="color: red;">0</strong>(余额不足，去充值)-->
                <input style="display: none;" type="radio" id="zfbPay" name="pay_type" value="1" onclick="$('#safepassSpan').hide()"
                               checked/>
                <input style="display: none;"  type="radio" id="yuePay" name="pay_type" value="0"   checked
                       onclick="$('#safepassSpan').show()"/> &nbsp;&nbsp;
                <input style="display: none;" type="radio" id="saveOrder" name="pay_type" value="2"/>
                <br/>
                <br/>

                <div id="safepassSpan" >支&nbsp;&nbsp;付&nbsp;&nbsp;&nbsp;密&nbsp;&nbsp;码：<input
