      ...
      <div class="well well-large">
        <g:form class="form-inline" action="list" >
          ...
          <g:select  value="${params.direction}" name="direction" optionKey="v" optionValue="queryShow" from="${[[v:"",queryShow:"全部"],[v:"0",queryShow:"收入"],[v:"1",queryShow:"支出"]]}" />
            ...
            收支类型：
          <g:select  value="${params.type}" name="type" optionKey="v" optionValue="queryShow" from="${[[v:"",queryShow:"全部"],[v:"1",queryShow:"[支出]验收商品"],[v:"2",queryShow:"[支出]发货运费 "],[v:"5",queryShow:"[支出]会员取消商品退款"],[v:"6",queryShow:"[支出]会员取消商品退运费"],[v:"10",queryShow:"[支出]退货退款"],[v:"11",queryShow:"[支出]空包退还代发费用"],[v:"15",queryShow:"[支出]发货运费(换货)"],[v:"17",queryShow:"[支出]换货差价支出"],[v:"19",queryShow:"[支出]会员充值"],[v:"21",queryShow:"[支出]会员取消商品退礼品费"],[v:"22",queryShow:"[支出]会员更换档口退货款"],[v:"25",queryShow:"[支出]会员强制停止订单退回货款"],[v:"28",queryShow:"[支出]会员强制停止订单退回物流费"],[v:"26",queryShow:"[支出]管理员直接对订单退运费"],[v:"27",queryShow:"[支出]管理员直接对商品退货款"],[v:"7",queryShow:"[收入]会员支付商品"],[v:"8",queryShow:"[收入]会员支付运费"],[v:"9",queryShow:"[收入]会员支付服务费"],[v:"3",queryShow:"[收入]会员对商品补款"],[v:"4",queryShow:"[收入]会员对运费补款"],[v:"12",queryShow:"[收入]会员支付退货服务费"],[v:"13",queryShow:"[收入]会员换货支付差价"],[v:"14",queryShow:"[收入]会员支付换货运费"],[v:"16",queryShow:"[收入]退货档口回款"],[v:"18",queryShow:"[收入]会员充值"],[v:"20",queryShow:"[收入]会员支付礼品费"],[v:"23",queryShow:"[收入]会员更换档口超过2次支付费用"],[v:"24",queryShow:"[收入]会员强制停止订单收取物流费"]]}" />
        ...
        <table class="table table-bordered">
          ...
          <g:each in="${list}" status="i" var="tranLog">
            <tr>
              ...
              <td>${tranLog.dateCreated}</td>
              <td>
                  <g:link target="_blank" controller="adminUser" action="list" params="[userid:tranLog.order_user]">${tranLog.order_user}</g:link>
                  </td>
