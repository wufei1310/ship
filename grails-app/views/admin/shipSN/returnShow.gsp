  ...
  <body>
    ...
    <div class="container body">
      ...
      <div class="page-header">
              ...
              <tr>
                <td >
                  ...
                  <strong >
                    ...
                    <g:if test="${returnOrder.isScan=='1'}">
                        (已扫描入库)
                    </g:if>
                    <g:if test="${returnOrder.isScan=='0'}">
                        (未扫描入库)
                    </g:if>
                </strong>
        ...
        <g:if test="${returnOrder.isScan=='0'}">
            <a  href="javascript:void(0)" onclick="beforeTuikuan()"  class=" btn btn-large btn-primary">核实是此申请单</a>
        </g:if>

        <g:link controller="adminShipSN" action="saleReturnList"  params="${params}" class=" btn btn-large ">返回</g:link>
        <g:form  name="checkSaleReturnForm"  data-validate="parsley" class="form-signin checkSaleReturnForm" controller="adminShipSN" action="checkReturn" method="post" target="innerFrame">
            <input type="hidden" name="returnOrderId" value="${returnOrder.id}"/>
            <input type="hidden" name="wuliu_sn" value="${params.wuliu_sn}"/>
        </g:form>
      ...
      <form     method="post" id="commonActionForm" target="innerFrame">
        ...
        <iframe id="innerFrame" name="innerFrame" height="0" frameborder="0"></iframe>
         <g:form controller="adminShipSN"  action="saleReturnList" params="${params}"   method="post" class="commonListForm">
        </g:form >
