      ...
      <g:form name="saleExchangeForm"   class="saleExchangeForm" action="doSaleExchange" method="post" target="innerFrame" data-validate="parsley" >
                ...
                <g:if test="${daiFaGoods.status != '6'}">
                  <tr class="daiFaGoods" >
                    <td rowspan="1">
                        ...
                        <select name="" class="span1" onchange="selReturnType(this);validGoods();">
                  ...
                  <tr style="display: none;" class="daiFaGoods success" >
                    ...
                    <td>
                        <input onchange="$(this).next().val($(this).val())"  disabled="disabled" onkeyup="if(value>${daiFaGoods.num})this.value=${daiFaGoods.num};if(isNaN(value) || value<=0)execCommand('undo')" onafterpaste="if(value>${daiFaGoods.num})this.value=${daiFaGoods.num};if(isNaN(value) || value<=0)execCommand('undo')" name="return_num_tip" class="input-small return_num_tip" type="text" value="${daiFaGoods.num}"/>
            ...
            <tbody>
              ...
              <tr>
                <td >
                  ...
                  物流单号：<input value="${params.wuliu_sn}" data-error-message="物流单号不能为空" data-required="true"   name="wuliu_sn"  type="text" placeholder=""  >
                  <br>
                  物流公司：
        ...
        <div class="bs-docs-example">
          <table class="table table-bordered">
            ...
            支付方式： <input type="radio" id="yuePay" name="pay_type" value="0" onclick="$('#safepassSpan').show()" checked/>余额支付 &nbsp;&nbsp;
