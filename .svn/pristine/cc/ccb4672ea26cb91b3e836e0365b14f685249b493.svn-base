...
<!--                    <option value="汇通" <g:if test="${order.wuliu == '汇通'}">selected</g:if>>汇通</option>-->
                    ...
                    <option value="大包" <g:if test="${order.wuliu == '大包'}">selected</g:if>>大包</option>
              ...
              <tr>
                <td >
                  ...
                  选择礼品：<select id="regards" name="regards" class="input-large" onchange="fee()">
                      ...
                      <option value="5" <g:if test="${order.regards == '5'}">selected</g:if>>换吊牌　更换包装袋</option>
                      <option value="2" <g:if test="${order.regards == '2'}">selected</g:if> >包装盒+小礼物</option>
                      <option value="4" <g:if test="${order.regards == '4'}">selected</g:if> >包装盒</option>
